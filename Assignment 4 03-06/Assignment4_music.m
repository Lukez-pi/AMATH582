...
function [] = save_test_training_data_2()
    ...
    root_dir = strcat("Music/", genre, file_format);
    files = dir(root_dir);
    artist_music = {files.name};
    for i = 1:3  % only going to be analyzing 3 different country singers
        file_path = strcat("Music/", genre, "/", artist_music{i});
        load(file_path);
        clip_num = size(data_matrix_rand, 2);
        training_num = floor(0.8 * clip_num);
        test_set_num = clip_num - training_num;
        training_set = [training_set, data_matrix_rand(:, 1:training_num)];
        training_set_label = [training_set_label; i * ones(training_num, 1)];
        test_set_data = [test_set_data, data_matrix_rand(:, training_num+1:end)];
        test_set_label = [test_set_label; i * ones(test_set_num, 1)];
    end
    save_dir_train = "Data/Q2/Part_2_training_data.mat";
    save_dir_train_label = "Data/Q2/Part_2_training_label.mat";
    save_dir_test = "Data/Q2/Part_2_test_data.mat";
    save_dir_test_label = "Data/Q2/Part_2_test_label.mat";
    save(save_dir_train, "training_set");
    save(save_dir_train_label, "training_set_label");
    save(save_dir_test, "test_set_data");
    save(save_dir_test_label, "test_set_label"); 
end
...
function [] = save_test_training_data_3()
    ...
    save_dir_train = "Data/Q2/Part_3_training_data.mat";
    save_dir_train_label = "Data/Q2/Part_3_training_label.mat";
    save_dir_test = "Data/Q2/Part_3_test_data.mat";
